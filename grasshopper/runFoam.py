...
from carbonfly.wsl import run_foam_console
...
try:
    ...
    if not run:
        ...
        logs.append("This component will execute:  buoyantReactingFoam")
        ...
        logs.append("")
        logs.append("[Run] Launching buoyantReactingFoam ...")
        ...
        if rc == 0:
            ...
            logs.append(f"[Warning] buoyantReactingFoam exited with return code: {rc}")
